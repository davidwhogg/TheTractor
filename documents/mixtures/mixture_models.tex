...
% - make sure the technical issues about convolution and interpolation don't exist *only* in the figure caption
...
$M^{\luv}=8$ are good compromises between mixture complexity ($M$) and
quality of fit.  Also, even the best-fitting late-type and early-type
galaxies deviate from exponential and de~Vaucouleurs fits by more than
do these high-quality mixture-of-Gaussian approxmations; no precision
is lost.
...
... finally: The insights that \emph{could} be gained by interrogating
these profile approximations in three dimensions...!
