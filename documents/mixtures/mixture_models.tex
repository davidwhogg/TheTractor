...
\caption{The amplitudes and root-variances for the best
  mixture-of-Gaussian approximations to the exp profile, for
  different mixture sizes.  The total (dimensionless) flux and the
  badness are given for each approximation.\label{tab:exp}}
\end{table}

\clearpage
\begin{table}
\input{table_dev}
\caption{Same as \tablename~\ref{tab:exp} but for the dev profile.}
\end{table}

\clearpage
\begin{table}
\input{table_lux}
\caption{Same as \tablename~\ref{tab:exp} but for the lux profile.}
\end{table}

\clearpage
\begin{table}
\input{table_luv}
\caption{Same as \tablename~\ref{tab:exp} but for the luv profile.\label{tab:luv}}
\end{table}
