...
function expansions (\citealt{bendi}).  Finally, a sampling
approximation---or any finite numerical approximation---is effectively
something like a ``mixture of delta functions'' or ``mixture of
integration kernels'' approximation.  Any such approximation (at fixed
accuracy) will have far more degrees of freedom (complexity) than the
MoG approximations given below.
