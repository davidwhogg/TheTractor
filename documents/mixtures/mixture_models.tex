...
\figurename s~\ref{fig:exp} through \ref{fig:M}... Discuss briefly the
import of it all... Why in the tables are we giving and plotting
root-variances not variances?...
...
\hline
$\sum_m a^{\exp}_m=$ &
\multicolumn{2}{|c|}{$2.55$} &
\multicolumn{2}{|c|}{$2.59$} &
\multicolumn{2}{|c|}{$2.60$} \\
badness\,$=$ &
\multicolumn{2}{|c|}{$1.55\times 10^{-4}$} &
\multicolumn{2}{|c|}{$1.55\times 10^{-4}$} &
\multicolumn{2}{|c|}{$1.55\times 10^{-4}$} \\
\end{tabular}
